...
const jin: Dynasty = {
  ...
  events: [
    { year: 266, title: '司马炎代魏', desc: '西晋建立', source: '《晋书》' },
    { year: 280, title: '灭东吴', desc: '三国归晋', source: '《晋书》' },
    { year: 311, title: '永嘉之乱', desc: '匈奴刘曜攻陷洛阳', source: '《晋书》' },
    { year: 317, title: '东晋建立', desc: '司马睿在建康即位', source: '《晋书》' },
    { year: 383, title: '淝水之战', desc: '东晋以少胜多，前秦瓦解', source: '《晋书》' },
    { year: 420, title: '刘裕代晋', desc: '南朝开始', source: '《宋书》' },
    { year: 494, title: '北魏孝文帝改革', desc: '迁都洛阳，全面汉化', source: '《魏书》' },
    { year: 589, title: '隋灭陈', desc: '南北朝结束', source: '《隋书》' },
  ],
...
const sui: Dynasty = {
  ...
  events: [
    { year: 589, title: '隋灭陈', desc: '南北朝结束，重新统一', source: '《隋书》' },
    { year: 605, title: '开凿大运河', desc: '贯通南北的大工程开始', source: '《隋书》' },
    { year: 610, title: '营建东都', desc: '洛阳成为政治副中心', source: '《隋书》' },
    { year: 611, title: '王薄起义', desc: '"知世郎"反隋', source: '《旧唐书》' },
    { year: 612, title: '一征高句丽', desc: '113 万大军出征大败', source: '《隋书》' },
    { year: 618, title: '江都之变', desc: '宇文化及杀杨广，隋亡', source: '《隋书》' },
  ],
  economy: {
    territory: 467,
    population: 4600,
...
const tang: Dynasty = {
  ...
  events: [
    { year: 618, title: '李渊称帝', desc: '建唐', source: '《旧唐书》' },
    { year: 627, title: '贞观之治', desc: '李世民缔造治世典范', source: '《旧唐书》' },
    { year: 690, title: '武则天称帝', desc: '中国唯一女皇', source: '《旧唐书》' },
    { year: 713, title: '开元盛世', desc: '唐朝国力达到顶峰', source: '《旧唐书》' },
    { year: 753, title: '鉴真东渡', desc: '中日文化交流里程碑', source: '《唐大和上东征传》' },
    { year: 755, title: '安史之乱', desc: '安禄山叛乱，**唐由盛转衰**', source: '《旧唐书》' },
    { year: 875, title: '黄巢起义', desc: '瓦解唐朝', source: '《旧唐书》' },
    { year: 907, title: '朱温代唐', desc: '唐亡，五代开始', source: '《新五代史》' },
  ],
  economy: {
    territory: 1237,
    population: 8000,
