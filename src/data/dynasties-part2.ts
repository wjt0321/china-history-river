...
const qin: Dynasty = {
  ...
  events: [
    { year: -356, title: '商鞅第一次变法', desc: '秦孝公任商鞅，废井田、奖军功', source: '《史记·商君列传》' },
    { year: -350, title: '商鞅第二次变法', desc: '废封建、立县制、徙都咸阳', source: '《史记·商君列传》' },
    { year: -238, title: '嬴政亲政', desc: '22 岁，铲除嫪毐、吕不韦', source: '《史记·吕不韦列传》' },
    { year: -230, title: '灭韩', desc: '秦灭六国开始', source: '《史记·秦始皇本纪》' },
    { year: -221, title: '统一六国', desc: '灭齐，**中国第一个大一统王朝建立**', source: '《史记·秦始皇本纪》' },
    { year: -220, title: '修驰道', desc: '"车同轨"，咸阳通全国', source: '《史记·秦始皇本纪》' },
    { year: -215, title: '北击匈奴', desc: '蒙恬收河南地，**筑万里长城**', source: '《史记·蒙恬列传》' },
    { year: -213, title: '焚书', desc: '除秦纪、医药、卜筮、种树外皆焚', source: '《史记·秦始皇本纪》' },
    { year: -212, title: '坑儒', desc: '活埋 460 余方士儒生', source: '《史记·秦始皇本纪》' },
    { year: -210, title: '嬴政卒', desc: '第五次东巡途中病逝，年 50', source: '《史记·秦始皇本纪》' },
    { year: -209, title: '大泽乡起义', desc: '陈胜吴广，"王侯将相宁有种乎"', source: '《史记·陈涉世家》' },
    { year: -207, title: '秦亡', desc: '子婴降于刘邦', source: '《史记·高祖本纪》' },
  ],
  economy: {
    territory: 440,
    population: 2000,
...
const han: Dynasty = {
  ...
  events: [
    { year: -206, title: '约法三章', desc: '刘邦入咸阳，"杀人者死，伤人及盗抵罪"', source: '《史记·高祖本纪》' },
    { year: -202, title: '刘邦称帝', desc: '垓下之战败项羽后称帝', source: '《史记·高祖本纪》' },
    { year: -139, title: '张骞出使', desc: '"凿空之旅"，开辟丝绸之路', source: '《史记·大宛列传》' },
    { year: -134, title: '罢黜百家', desc: '"独尊儒术，罢黜百家"', source: '《汉书·董仲舒传》' },
    { year: -127, title: '推恩令', desc: '削弱诸侯王', source: '《史记·汉兴以来诸侯王年表》' },
    { year: 105, title: '蔡伦造纸', desc: '"蔡侯纸"改进造纸术', source: '《后汉书·蔡伦传》' },
    { year: 89, title: '班超平西域', desc: '东汉再通西域', source: '《后汉书·班超传》' },
    { year: 184, title: '黄巾起义', desc: '瓦解东汉统治', source: '《后汉书》' },
    { year: 220, title: '曹丕代汉', desc: '东汉灭亡', source: '《三国志》' },
  ],
  economy: {
    territory: 1020,
    population: 5600,
...
const sanguo: Dynasty = {
  ...
  events: [
    { year: 200, title: '官渡之战', desc: '曹操以少胜多击败袁绍', source: '《三国志》' },
    { year: 208, title: '赤壁之战', desc: '孙刘联军大败曹操', source: '《三国志》' },
    { year: 220, title: '曹丕代汉', desc: '魏国建立', source: '《三国志》' },
    { year: 221, title: '刘备称帝', desc: '蜀汉建立', source: '《三国志》' },
    { year: 229, title: '孙权称帝', desc: '东吴建立，三国鼎立成形', source: '《三国志》' },
    { year: 263, title: '蜀汉灭亡', desc: '魏灭蜀', source: '《三国志》' },
    { year: 265, title: '司马代魏', desc: '西晋建立', source: '《晋书》' },
    { year: 280, title: '西晋灭吴', desc: '三国归晋', source: '《晋书》' },
  ],
