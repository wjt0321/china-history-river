...
const wudai: Dynasty = {
  ...
  events: [
    { year: 907, title: '朱温代唐', desc: '后梁建立，五代开始', location: '开封', coords: [114.3, 34.8], source: '《新五代史》' },
    { year: 936, title: '割让燕云十六州', desc: '石敬瑭认契丹为父', location: '太原', coords: [112.5, 37.9], source: '《新五代史》' },
    { year: 960, title: '陈桥兵变', desc: '赵匡胤建立北宋', location: '陈桥驿', coords: [114.0, 35.0], source: '《宋史》' },
  ],
...
const song: Dynasty = {
  ...
  events: [
    { year: 960, title: '陈桥兵变', desc: '赵匡胤黄袍加身', location: '陈桥驿', coords: [114.0, 35.0], source: '《宋史》' },
    { year: 976, title: '杯酒释兵权', desc: '解除武将兵权', location: '开封', coords: [114.3, 34.8], source: '《宋史》' },
    { year: 1004, title: '澶渊之盟', desc: '宋辽和议，每年给岁币', location: '澶州', coords: [115.0, 35.7], source: '《宋史》' },
    { year: 1069, title: '王安石变法', desc: '试图扭转"三冗"困境', location: '开封', coords: [114.3, 34.8], source: '《宋史》' },
    { year: 1088, title: '《梦溪笔谈》', desc: '沈括撰成', location: '润州', coords: [119.4, 32.2], source: '《梦溪笔谈》' },
    { year: 1127, title: '靖康之难', desc: '金军攻陷汴京，**北宋灭亡**', location: '开封', coords: [114.3, 34.8], source: '《宋史》' },
    { year: 1279, title: '崖山海战', desc: '南宋亡于元，文天祥殉国', location: '崖山', coords: [113.1, 22.2], source: '《宋史》' },
  ],
  economy: {
    territory: 280,
    population: 10000,
...
const yuan: Dynasty = {
  ...
  events: [
    { year: 1206, title: '成吉思汗建蒙古国', desc: '铁木真统一蒙古各部', location: '斡难河', coords: [115.8, 48.8], source: '《元史》' },
    { year: 1271, title: '忽必烈改国号', desc: '建国号"大元"', location: '大都', coords: [116.4, 39.9], source: '《元史》' },
    { year: 1279, title: '崖山海战', desc: '南宋灭亡', location: '崖山', coords: [113.1, 22.2], source: '《元史》' },
    { year: 1292, title: '《授时历》颁行', desc: '郭守敬编制，精确度领先世界三百年', location: '大都', coords: [116.4, 39.9], source: '《元史》' },
    { year: 1351, title: '红巾军起义', desc: '元末农民战争爆发', location: '颍州', coords: [115.8, 32.9], source: '《明史》' },
    { year: 1368, title: '明军攻陷大都', desc: '元亡', location: '大都', coords: [116.4, 39.9], source: '《明史》' },
  ],
  economy: {
    territory: 1372,
    population: 9000,
