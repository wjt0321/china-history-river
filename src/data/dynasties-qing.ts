...
export const qing: Dynasty = {
  ...
  riseReasons: [
    ...
    { year: 1616, title: '后金建立', desc: '努尔哈赤建立后金', source: '《清史稿》' },
    { year: 1636, title: '改国号清', desc: '皇太极改国号"大清"', source: '《清史稿》' },
    { year: 1644, title: '清军入关', desc: '吴三桂引清军入关', source: '《清史稿》' },
    { year: 1683, title: '统一台湾', desc: '施琅攻台', source: '《清史稿》' },
    { year: 1689, title: '《尼布楚条约》', desc: '中俄第一份边界条约', source: '《清史稿》' },
    { year: 1722, title: '康熙逝世', desc: '在位 61 年', source: '《清史稿》' },
    { year: 1729, title: '设军机处', desc: '雍正设立军机处', source: '《清史稿》' },
    { year: 1796, title: '白莲教起义', desc: '**康乾盛世终结**', source: '《清史稿》' },
    { year: 1840, title: '鸦片战争', desc: '**中国近代史开端**', source: '《清史稿》' },
    { year: 1842, title: '《南京条约》', desc: '中国近代第一份不平等条约', source: '《清史稿》' },
    { year: 1851, title: '太平天国', desc: '金田起义', source: '《清史稿》' },
    { year: 1860, title: '火烧圆明园', desc: '英法联军暴行', source: '《清史稿》' },
    { year: 1894, title: '甲午战争', desc: '清朝惨败于日本', source: '《清史稿》' },
    { year: 1898, title: '戊戌变法', desc: '百日维新失败', source: '《清史稿》' },
    { year: 1900, title: '八国联军', desc: '《辛丑条约》签订', source: '《清史稿》' },
    { year: 1911, title: '辛亥革命', desc: '武昌起义', source: '《清史稿》' },
    { year: 1912, title: '宣统退位', desc: '**两千余年帝制终结**', source: '《清史稿》' },
